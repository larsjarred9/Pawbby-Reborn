  ...
  <div class="min-h-screen bg-pawbby-dark flex items-center justify-center p-4">
    <div class="bg-pawbby-card rounded-3xl p-8 w-full max-w-md border border-white/5 relative overflow-hidden">
      ...
      <div class="text-center mb-8 relative">
        ...
        <p class="text-pawbby-muted">Create your local admin account to secure your Pawbby Reborn dashboard.</p>
      </div>

      <form @submit.prevent="handleRegister" class="space-y-5 relative z-10">
        <div>
          <label class="block text-sm font-medium text-pawbby-muted mb-2">Display Name</label>
        ...
        <div>
          <label class="block text-sm font-medium text-pawbby-muted mb-2">Password</label>
